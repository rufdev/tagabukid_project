...
using BIPS.Repository.Pattern.DataContext;
using BIPS.Repository.Pattern.Infrastructure;
using BIPS.Repository.Pattern.Repositories;
using BIPS.Repository.Pattern.UnitOfWork;
using BIPS.Repository.Pattern.Ef6.Factories;
#endregion

namespace BIPS.Repository.Pattern.EF.Factories
{
    /// <summary>
    ...
    public class RepositoryProvider : IRepositoryProvider
    {
        ...
        /// <summary>
        ///     Get and set the <see cref="EF.DataContext" /> with which to initialize a repository if one must be created.
        /// </summary>
        ...
        ///     The <see cref="EF.DataContext" /> with which to initialize the repository.
        /// </param>
        /// <param name="factory">
        ///     Factory with <see cref="EF.DataContext" /> argument. Used to make the repository.
